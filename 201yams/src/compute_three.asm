...
%define THREE_EXPECTED_DICE 3

[section .rodata]
    custum_format db "Chances to get a %d three: %0.2f%%", 10, 0
...
chance_max:
    ...
    jmp compute_three_end

compute_chance:
    mov rax, DICE_FACE_NB
    sub rax, [nb_apparition]
    cmp r10, rax
    jge compute_three_end
...
compute_three:
    ...
    cmp R8, THREE_EXPECTED_DICE
    jge chance_max
    mov r9, 5
    sub r9, [nb_apparition]
    mov r10, THREE_EXPECTED_DICE
