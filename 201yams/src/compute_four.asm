...
%define FOUR_EXPECTED_DICE 4

[section .rodata]
    custum_format db "Chances to get a %d four-of-a-kind: %0.2f%%", 10, 0
...
compute_four:
    ...
    cmp R8, FOUR_EXPECTED_DICE
    jge chance_max
    mov r9, 5
    sub r9, [nb_apparition]
    mov r10, FOUR_EXPECTED_DICE
